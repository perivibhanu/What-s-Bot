...
const chatSessionSchema = new mongoose.Schema({
  ...
  securityId: { type: mongoose.Schema.Types.ObjectId, ref: 'SecurityGuard' },
  driverId: { type: mongoose.Schema.Types.ObjectId, ref: 'Driver' },
  activeGate: { type: String, default: 'Gate 1 (Hostel Gate)' },
  selectedWardenId: { type: mongoose.Schema.Types.ObjectId, ref: 'Warden' },
  userType: { type: String, enum: ['visitor', 'student', 'staff', 'parent', 'warden', 'security', 'driver'], default: 'visitor' },
